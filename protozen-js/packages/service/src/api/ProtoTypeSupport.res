@module("@protozen/service/src/api/proto-type-support") external decode: (Js_typed_array.ArrayBuffer.t, _) => 'a = "d"
@module("@protozen/service/src/api/proto-type-support") external encode: (_, _) => Js_typed_array.array_buffer = "e"
@module("@protozen/service/src/api/proto-type-support") external verify: ('a, _) => option<string> = "v"
module FromRecord = {
  @module("@protozen/service/src/api/proto-type-support") @scope("fromRecord") external string: ('a, string, _) => 'a = "string"
